...
int main(void) {
  ...
  while (!WindowShouldClose()) {
    ...
    if (Scene == 2) {
      ...
      switch (Squares[1]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 - 37.5, screenHeight / 2 - 137.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[2]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 + 62.5, screenHeight / 2 - 137.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[3]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 - 137.5, screenHeight / 2 - 37.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[4]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 - 37.5, screenHeight / 2 - 37.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[5]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 + 62.5, screenHeight / 2 - 37.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[6]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 - 137.5, screenHeight / 2 + 62.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[7]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 - 37.5, screenHeight / 2 + 62.5,
                    RAYWHITE);
        break;
      case 1:
      ...
      switch (Squares[8]) {
      case 0:
        DrawTexture(BlankTile, screenWidth / 2 + 62.5, screenHeight / 2 + 62.5,
                    RAYWHITE);
        break;
      case 1:
